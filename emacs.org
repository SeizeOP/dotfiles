...
#+begin_src emacs-lisp
  (hd/leader-keys
    ...
    "o b" '(browse-url-xdg-open :wk "open a URL in the XDG default browser"))
#+end_src
...
- Creddit: [[https://old.reddit.com/r/emacs/comments/lrgah8/popup_terminaleshell_in_emacs/][Reddit]], [[https://emacs.stackexchange.com/questions/13579/how-to-open-shell-or-eshell-in-a-new-window-or-frame][Emacs Stackexchange]]
...
#+export_file_name: ~/Documents/html/system/emacs.html
