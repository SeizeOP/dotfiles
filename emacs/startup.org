...
| SPC f c   | [[elisp:(find-file (concat (getenv "HOME") "/dotfiles/emacs/emacs.org"))][emacs.org]]           | Open Emacs Personal [[./emacs.org][config]]         |
...
|---+--------------------------+--------------------------------------------------------|
| =1= | [[elisp:(find-file (concat (getenv "HOME") "/dotfiles/emacs/emacs.org"))][config.org]]               | This is the main user configuration file for Emacs.    |
