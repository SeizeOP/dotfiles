...
- [[#imagesemacs-orgpng][[[./images/emacs-org.png]]]]
...
- specify the background color, and font color fo source code blocks
#+HTML_HEAD: <style>pre.src{background:#282a36;color:white;} </style>

- Specify the background color of code blocks. In my case these somewhat interchangable with regualar quotes, as most of the extensive code is placed in source code blocks. 
