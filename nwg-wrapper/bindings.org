...
Web browser		<span foreground="#6699cc" face="serif">Mod+B</span>
Toggle floating		<span foreground="#6699cc" face="serif">Mod+V</span>
...
#+export_file_name: ~/Documents/html/system/nwg_wrapper.html
